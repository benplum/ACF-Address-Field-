...
if( !class_exists('pw_acf_field_address') ) :


class pw_acf_field_address extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// // register & include JS
		// wp_register_script('pw_acf_address-js', "{$url}assets/js/input.js", array('acf-input'), $version);
		// wp_enqueue_script('pw_acf_address-js');


		// register & include CSS
		wp_register_style('pw_acf_address-css', "{$url}assets/css/input.css", array('acf-input'), $version);
		wp_enqueue_style('pw_acf_address-css');
...
// initialize
new pw_acf_field_address( $this->settings );
